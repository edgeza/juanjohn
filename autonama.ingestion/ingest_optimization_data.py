#!/usr/bin/env python3
"""
Optimization Data Ingestion Script
...
Usage:
    python ingest_optimization_data.py

This script should be run from your PC after the Docker containers are running.
"""
...
class DockerOptimizationIngestion:
    def __init__(self):
        ...
        # Docker database configuration - connects to running PostgreSQL container
        self.db_config = {
    ...
    def connect_database(self):
        ...
        try:
            ...
            logger.error("Make sure Docker containers are running and PostgreSQL is accessible on localhost:5432")
            raise
...
def main():
    ...
    try:
        ...
        print("2. PostgreSQL must be accessible on localhost:5432")
        ...
        print("2. Check if PostgreSQL is accessible: telnet localhost 5432")
