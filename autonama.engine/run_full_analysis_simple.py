#!/usr/bin/env python3
"""
Simple Full Analysis Runner for Crypto Engine
...
No emoji characters used to avoid encoding issues.
"""
...
# Configure logging to suppress UnicodeEncodeError
